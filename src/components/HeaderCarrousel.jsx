            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center ">
                <div className="flex flex-col p-4 text-center">
                    ...
                    <div className="drop-shadow">
                        <h1 className="text-3xl font-extrabold [text-shadow:_0_0.8px_0_rgb(0_0_0_/_60%)]">
                            Entrenando el futuro de Chile
                        </h1>
                    </div>
                </div>

                <button className="px-2 py-2 bg-blue rounded-lg text-white font-semibold transition duration-500 hover:scale-110 hover:bg-yellow hover:shadow-lg hover:text-black">
                    Contáctanos
                </button>
            </div>
        </section>
